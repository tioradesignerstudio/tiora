...
export default function ProductManagement() {
  ...
  const resetForm = () => {
    setEditingId(null);
    setName(""); setDescription(""); setGender("women"); setCategory(""); setFilterCategory("");
                    ...
                    <div key={color} className="p-6 bg-brand/5 rounded-[2.5rem] border border-brand/10 space-y-4">
                      ...
                      <div className="flex gap-3">
                        <div className="flex-1 flex gap-2">
                          ...
                          />
                          <label className="shrink-0 flex items-center justify-center bg-[#333333] hover:bg-[#222222] text-[#faf8f0] rounded-2xl px-4 py-2 text-xs font-bold uppercase tracking-wider cursor-pointer transition-colors shadow-md">
                            {uploadingColor === color ? "Uploading..." : "Upload Local"}
                            <input
                              type="file"
                              accept="image/*"
