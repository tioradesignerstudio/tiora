...
import { Sparkles, ArrowLeft, Check, X, Heart } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-brand-light text-brand font-sans selection:bg-brand-accent/30">
      <main className="max-w-7xl mx-auto px-6 md:px-12 pt-16 pb-16">
            ...
            <div className="mt-auto pt-6 border-t border-brand/5 flex items-center gap-4 w-full">
              ...
              >
                {added ? (
                  ...
                  <ShoppingBagIcon size={22} className="transition-all" />
                )}
        ...
        {toast && (
          <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-50 bg-[#333333] text-[#faf8f0] px-8 py-4 rounded-2xl shadow-2xl flex items-center space-x-3 font-bold text-sm animate-in fade-in slide-in-from-bottom-5 duration-300">
            <Check size={18} />
            <span>{toast}</span>
          </div>
        )}
            ...
            <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
              <div className="relative aspect-[3/4] w-full rounded-2xl overflow-hidden border border-brand/5 bg-white">
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src = "https://placehold.co/600x800/faf8f0/333333?text=Size+Guide+Image+Not+Found";
                  }}
                />
              </div>
